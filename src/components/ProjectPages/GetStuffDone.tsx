...
export default function GetStuffDone():JSX.Element {
    return (
        ...
        <div className='project_buttons'>
            <button className='project_button-live' onClick={() => window.open("https://getstuffdone.maghfoor.com/login", "_self")}>Live Site</button>
            <button className='project_button-code' onClick={() => window.open("https://github.com/maghfoor-a/fullstack-todo-frontend", "_self")}>See The Code</button>
        </div>
        <p className="project_description">Get Stuff Done is a web application that helps users stay organized and on top of their tasks. The front end is built using <b>React</b> and <b>Typescript</b>, and the backend is built using <b>Express</b> and Typescript. The site is deployed on <b>Netlify</b> and uses <b>Firebase</b> for authentication and a <b>postgreSQL</b> database. The project was built using <b>Git</b> for version control and <b>Jest</b> for testing. This project has been a valuable learning experience for me, allowing me to gain experience in building a full-stack web application with authentication and a database.</p>
        </section>
        <section>
