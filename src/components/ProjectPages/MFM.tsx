      ...
      <section>
        ...
        <div className="project_buttons">
          <button
            ...
            onClick={() =>
              window.open("https://myfavouritemedia.maghfoor.com/", "_self")
            }
          >
            Live Site
          </button>
          <button
            ...
            onClick={() =>
              window.open(
                "https://github.com/maghfoor-a/my-favourite-media",
                "_self"
              )
            }
          >
        ...
        <p className="project_description">
          I developed a React web application that utilizes the{" "}
          <b>Spotify API</b> to allow users to search for artists and their
          albums, and to save their favorite albums. The goal of the app was to
          provide a simple and intuitive solution for storing and organizing
          music, as existing options did not meet my needs. The app leverages
          the Spotify API to offer a comprehensive and user-friendly experience
