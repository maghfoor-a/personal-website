      ...
      <section>
        ...
        <div className="project_buttons">
          ...
          <button
            ...
            onClick={() =>
              window.open(
                "https://github.com/maghfoor-a/zmdb-tv-shows",
                "_self"
              )
            }
          >
        ...
        <p className="project_description">
          I developed ZMDB, a react web application that allows users to search
          for their favorite TV shows and filter episodes based on search
          criteria. I collaborated with a partner on this project as part of the
          Academy program, and we worked with an <b>API</b> to fetch and display
          data on the website. This project helped me enhance my React skills
          and gain experience with <b>unit testing</b> using Jest. I also had
          the opportunity to improve my team work and <b>Git</b> skills through
          the use of pull requests and branches in GitHub. Overall, this project
          was a valuable learning experience for me, providing an opportunity to
          work on a real-world project and develop skills in web development and{" "}
          <b>collaboration</b>.
        </p>
      </section>
      <section>
