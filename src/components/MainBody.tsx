    ...
    return (
        ...
        <section className="projects" id="projects">
            ...
            <div className="portfolio">
                {/*Item 1 */}
                <div onClick={() => window.open("/mfm", "_self")} className="portfolio__item">
                ...
                {/*Item 2 */}
                <div onClick={() => window.open("/getstuffdone", "_self")} className="portfolio__item">
                ...
                {/*Item 3 */}
                <div onClick={() => window.open("/zmdb", "_self")} className="portfolio__item">
